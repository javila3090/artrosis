...
<html>
    <head>
        ...
        <title>Centro de artrosis | Dashboard</title>
    ...
    <body >
        ...
        <script>
            ...
            $('.delete-quote').on('click', function(){
                ...
                swal({   
                    title: "¿Estás Seguro?",
                    text: "La cotización seleccionada será eliminada",
                    type: "warning",   
                    showCancelButton: true,   
                    confirmButtonColor: "#DD6B55",
                    confirmButtonText: "Sí, estoy seguro", 
            ...
            $('.delete-agreement').on('click', function(){
                ...
                swal({   
                    title: "¿Estás Seguro?",
                    text: "La solicitud seleccionada será eliminada",
                    type: "warning",   
                    showCancelButton: true,   
                    confirmButtonColor: "#DD6B55",
                    confirmButtonText: "Sí, estoy seguro", 
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type: 'GET',
                            url: '/admin/agreements/destroy/'+id,
                            success: function(data) {
                                if(data.message=='Ok'){
                                    swal(
                                        '¡Hecho!',
